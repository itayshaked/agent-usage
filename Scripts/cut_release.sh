...
# Casks/agentusage.rb. Requires this repo to be pushed to GitHub and `gh`
# authenticated.
...
gh release create "$TAG" "$ZIP" \
  --title "AgentUsage ${VERSION}" \
  --notes "Automated release for AgentUsage ${VERSION}."

echo ""
echo "════════════════════════════════════════════════════"
echo "Paste these into Casks/agentusage.rb, then commit & push:"
echo ""
